...
public class Main {
    ...
    Aluno aluno3 = new Aluno("Washington ", "Damacena ","Estratégias educativas em saúde para reduzir a incidência de gravidez na adolescencia", false);
        System.out.println("A quantidade de convidados de " + aluno3.getNome() + aluno3.getSobrenome() + " é: " + aluno3.convidarPessoas(5));
    ...
    Convidado convidado2 = new Convidado("FilhaDaJulia", "Carvalho","Sim", true);
